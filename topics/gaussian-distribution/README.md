...
- **[Diffusion Models](../diffusion-models/README.md)**: Использование гауссова распределения для добавления и удаления шума
- **[Variational Autoencoders (VAEs)](../variational-autoencoders-vaes/README.md)**: Гауссово распределение в latent space
