...
- Harness = всё вокруг модели, что **заземляет** её в контролируемой среде (Claude Code / Cursor как примеры).
- Решение проблем агента через **код обвязки**, а не «prompt harder».
- **Open RAG** как enterprise-пример; сильный harness позволяет выжать максимум из дешёвых моделей.
