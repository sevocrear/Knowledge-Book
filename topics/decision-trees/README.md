...
- [Cross Entropy and Focal Loss](../classification-losses-cross-entropy-focal-loss/README.md) — энтропия в loss-функциях
- [Ensemble Methods & Model Combination](../ensemble-methods-model-combination/README.md) — Random Forest, Boosting, Stacking и другие ансамбли на основе деревьев
