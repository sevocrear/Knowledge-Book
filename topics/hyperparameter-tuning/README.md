...
- [Ensemble Methods & Model Combination](../ensemble-methods-model-combination/README.md) — тюнинг ансамблей (n_estimators, learning_rate для GBDT)
- [ROC Curves and ROC AUC](../roc-curve-and-roc-auc/README.md) — ROC AUC как метрика для тюнинга
- [Cross Entropy and Focal Loss](../classification-losses-cross-entropy-focal-loss/README.md) — loss-функции, через которые оценивается качество
