...
- [ROC Curves and ROC AUC](../roc-curve-and-roc-auc/README.md) — метрика оценки моделей в ансамблях
- [Cross Entropy and Focal Loss](../classification-losses-cross-entropy-focal-loss/README.md) — loss-функции, используемые в Boosting
- [Transformers, Attention and ViT](../transformers-attention-and-vision-transformers-vit/README.md) — архитектура для MoE
- [Low-Rank Adaptation (LoRA)](../low-rank-adaptation-lora/README.md) — fine-tuning перед Model Merging
- [Normalization Layers](../normalization-layers-batchnorm-layernorm/README.md) — BatchNorm и SWA
- [Hyperparameter Tuning](../hyperparameter-tuning/README.md) — настройка гиперпараметров ансамблей (n_estimators, learning_rate и т.д.)
