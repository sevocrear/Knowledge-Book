...
- [Gaussian Distribution (Normal Distribution)](../gaussian-distribution/README.md) — фундаментальное распределение, используемое в байесовском выводе
- [Variational Autoencoders (VAEs)](../variational-autoencoders-vaes/README.md) — применение теоремы Байеса для генеративных моделей
- [Unscented Kalman Filter](../unscented-kalman-filter-and-tracking/README.md) — рекурсивное байесовское обновление для фильтрации
- [Retrieval-Augmented Generation (RAG)](../retrieval-augmented-generation-rag/README.md) — байесовская интерпретация retrieval
- [ROC Curves and ROC AUC](../roc-curve-and-roc-auc/README.md) — метрики классификации, связанные с оценкой вероятностей
