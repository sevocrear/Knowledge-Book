...
### Related Documents
- **[ROC-кривые и ROC AUC](./roc-curve-and-roc-auc.md)** — выбор порога и оценка качества при ранжировании.
- **[Cross Entropy and Focal Loss](./classification-losses-cross-entropy-focal-loss.md)** — связь loss с вероятностями классов.
- **[Bayes' Theorem and Probability Foundations](./bayes-theorem-and-probability-foundations.md)** — вероятностная база, на которой живёт калибровка.
- **[Ensemble Methods & Model Combination](./ensemble-methods-model-combination.md)** — ансамбли как источник улучшения неопределенности.
